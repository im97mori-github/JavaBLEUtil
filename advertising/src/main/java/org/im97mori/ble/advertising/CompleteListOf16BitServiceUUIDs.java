...
public class CompleteListOf16BitServiceUUIDs extends AbstractAdvertisingData {
	 ...
	 * @see #CompleteListOf16BitServiceUUIDs(byte[], int, int)
	 */
	public CompleteListOf16BitServiceUUIDs(@NonNull byte[] data, int offset) {
     ...
     */
    public CompleteListOf16BitServiceUUIDs(@NonNull byte[] data, int offset, int length) {
        super(length);
     ...
     */
    public CompleteListOf16BitServiceUUIDs(@NonNull UUID... uuids) {
     ...
     */
    public CompleteListOf16BitServiceUUIDs(@NonNull List<UUID> uuidList) {
    ...
    public int getDataType() {
        return COMPLETE_LIST_OF_16_BIT_SERVICE_CLASS_UUIDS_DATA_TYPE;
    }
