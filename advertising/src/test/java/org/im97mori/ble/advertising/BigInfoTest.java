...
public class BigInfoTest extends TestBase {
	...
	public void test_constructor_2_00001() {
		...
		BigInfo result1 = new BigInfo(data, 0);
		assertEquals(34, result1.getLength());
		assertEquals(BIG_INFO_DATA_TYPE, result1.getDataType());
		assertEquals(0, result1.getBigOffset());
		assertEquals(0, result1.getBigOffsetUnits());
	...
	public void test_constructor_3_00001() {
		...
		BigInfo result1 = new BigInfo(bigOffset, bigOffsetUnits, isoInterval, numBis, nse, bn, subInterval, pto,
