...
public class BloodPressureMeasurementUtils {
	...
	/**
	 * kPa unit 1000 (pascal)
	 */
	public static final double PASCAL_RESOLUTION = 1000d;
	 ...
	 * @return {@code true}:same as expect, {@code false}:not match
	 */
	protected static boolean isMeasurementStatusMatched(int mask, int expect, byte[] measurementStatus) {
		return (mask & BLEUtils.createSInt16(measurementStatus, 0)) == expect;
	}

	/**
	 * @param kpa Systolic (kPa), Diastolic (kPa), Mean Arterial Pressure (kPa)
	 * @return pascal value
	 */
	public static double getPascal(IEEE_11073_20601_SFLOAT kpa) {
		return PASCAL_RESOLUTION * kpa.getSfloat();
	}
