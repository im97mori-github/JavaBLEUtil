...
/**
 * Utility for org.bluetooth.unit.thermodynamic_temperature(0x2AE9) characteristic
 */
public class CorrelatedColorTemperatureUtils {
    ...
    /**
     * @return {@code true}:Correlated Color Temperature value is not known, {@code false}:has Correlated Color Temperature value information
