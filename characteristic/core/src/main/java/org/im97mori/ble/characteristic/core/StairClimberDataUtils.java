...
/**
 * Utility for org.bluetooth.characteristic.stair_climber_data(0x2AD0)
 * characteristic
 */
public class StairClimberDataUtils {
	...
	/**
	 * @param flags flags
	 * @return {@code true}:Step per Minute not present, {@code false}:Step per
	 *         Minute present
	 */
	...
	/**
	 * @param flags flags
	 * @return {@code true}:Step per Minute present, {@code false}:Step per Minute
	 *         mpt present
	 */
	...
	/**
	 * @param flags flags
	 * @return {@code true}:Average Step Rate not Present, {@code false}:Average
	 *         Step Rate Present
	 */
	...
	/**
	 * @param flags flags
	 * @return {@code true}:Average Step Rate Present, {@code false}:Average Step
	 *         Rate not Present
	 */
	...
	/**
	 * @param flags flags
	 * @return {@code true}:Positive Elevation Gain not present,
	 *         {@code false}:Positive Elevation Gain present
	 */
	public static boolean isFlagsPositiveElevationGainNotPresent(@NonNull byte[] flags) {
		return isFlagsMatched(FLAGS_POSITIVE_ELEVATION_GAIN_PRESENT_MASK, FLAGS_POSITIVE_ELEVATION_GAIN_PRESENT_FALSE,
				flags);
	}

	/**
	 * @param flags flags
	 * @return {@code true}:Positive Elevation Gain present, {@code false}:Positive
	 *         Elevation Gain not present
	 */
	public static boolean isFlagsPositiveElevationGainPresent(@NonNull byte[] flags) {
		return isFlagsMatched(FLAGS_POSITIVE_ELEVATION_GAIN_PRESENT_MASK, FLAGS_POSITIVE_ELEVATION_GAIN_PRESENT_TRUE,
				flags);
	}

	/**
	 * @param flags flags
	 * @return {@code true}:Stride Count not Present, {@code false}:Stride Count
	 *         Present
	 */
	...
	/**
	 * @param flags flags
	 * @return {@code true}:Stride Count Present, {@code false}:Stride Count not
	 *         Present
	 */
	...
	/**
	 * @param flags flags
	 * @return {@code true}:Expended Energy not present, {@code false}:Expended
	 *         Energy present
	 */
	...
	/**
	 * @param flags flags
	 * @return {@code true}:Expended Energy present, {@code false}:Expended Energy
	 *         not present
	 */
	...
	/**
	 * @param flags flags
	 * @return {@code true}:Metabolic Equivalent not present,
	 *         {@code false}:Metabolic Equivalent present
	 */
	...
	/**
	 * @param flags flags
	 * @return {@code true}:Metabolic Equivalent present, {@code false}:Metabolic
	 *         Equivalent not present
	 */
	...
	/**
	 * @param flags flags
	 * @return {@code true}:Elapsed Time not present, {@code false}:Elapsed Time
	 *         present
	 */
	...
	/**
	 * @param flags flags
	 * @return {@code true}:Elapsed Time present, {@code false}:Elapsed Time not
	 *         present
	 */
	...
	/**
	 * @param flags flags
	 * @return {@code true}:Remaining Time not present {@code false}:Remaining Time
	 *         present
	 */
	...
	/**
	 * @param flags flags
	 * @return {@code true}:Remaining Time present, {@code false}:Remaining Time not
	 *         present
	 */
	 ...
	 * @return {@code true}:Total Energy Data Not Available, {@code false}:Total
	 ...
	 * @return {@code true}:Energy per Hour Data Not Available, {@code false}:Energy
	 *         per Hour Data Data Available
	 */
	 ...
	 * @return {@code true}:Energy per Minute Data Not Available,
	 *         {@code false}:Energy per Minute Data Data Available
	 */
