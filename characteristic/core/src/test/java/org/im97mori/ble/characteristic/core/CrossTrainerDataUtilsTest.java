...
public class CrossTrainerDataUtilsTest extends TestBase {
    ...
    public void test_00001() {
        ...
        assertEquals(CrossTrainerDataUtils.INSTANTANEOUS_SPEED_RESOLUTION * BLEUtils.createUInt16(data, 3), CrossTrainerDataUtils.getInstantaneousSpeedKilometerPerHour(BLEUtils.createUInt16(data, 3)), 0);
    }
    ...
    public void test_00102() {
        ...
        assertEquals(CrossTrainerDataUtils.AVERAGE_SPEED_RESOLUTION * BLEUtils.createUInt16(data, 3), CrossTrainerDataUtils.getAverageSpeedKilometerPerHour(BLEUtils.createUInt16(data, 3)), 0);
    }
    ...
    public void test_00402() {
        ...
        assertEquals(CrossTrainerDataUtils.STRIDE_COUNT_RESOLUTION * BLEUtils.createUInt16(data, 3), CrossTrainerDataUtils.getStrideCountWithUnit(BLEUtils.createUInt16(data, 3)), 0);
    }
    ...
    public void test_00602() {
        ...
        assertEquals(CrossTrainerDataUtils.INCLINATION_RESOLUTION * BLEUtils.createSInt16(data, 3), CrossTrainerDataUtils.getInclinationPercent(BLEUtils.createUInt16(data, 3)), 0);
        assertFalse(CrossTrainerDataUtils.isRampAngleSettingDataNotAvailable(BLEUtils.createSInt16(data, 5)));
        assertEquals(CrossTrainerDataUtils.RAMP_ANGLE_SETTING_RESOLUTION * BLEUtils.createSInt16(data, 5), CrossTrainerDataUtils.getRampAngleSettingDegree(BLEUtils.createSInt16(data, 5)), 0);
    }
    ...
    public void test_00702() {
        ...
        assertEquals(CrossTrainerDataUtils.RESISTANCE_LEVEL_RESOLUTION * BLEUtils.createSInt16(data, 3), CrossTrainerDataUtils.getResistanceLevelWithUnit(BLEUtils.createUInt16(data, 3)), 0);
    }
    ...
    public void test_01202() {
        ...
        assertEquals(CrossTrainerDataUtils.METABOLIC_EQUIVALENT_RESOLUTION * BLEUtils.createUInt8(data, 3), CrossTrainerDataUtils.getMetabolicEquivalentWithUnit(BLEUtils.createUInt8(data, 3)), 0);
    }
