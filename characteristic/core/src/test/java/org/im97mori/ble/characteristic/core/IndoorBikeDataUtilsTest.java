...
public class IndoorBikeDataUtilsTest extends TestBase {
    ...
    public void test_00001() {
        ...
        assertEquals(IndoorBikeDataUtils.INSTANTANEOUS_SPEED_RESOLUTION * BLEUtils.createUInt16(data, 2), IndoorBikeDataUtils.getInstantaneousSpeedKilometerPerHour(BLEUtils.createUInt16(data, 2)), 0);
    }
    ...
    public void test_00102() {
        ...
        assertEquals(IndoorBikeDataUtils.AVERAGE_SPEED_RESOLUTION * BLEUtils.createUInt16(data, 2), IndoorBikeDataUtils.getAverageSpeedKilometerPerHour(BLEUtils.createUInt16(data, 2)), 0);
    }
    ...
    public void test_00202() {
        ...
        assertEquals(IndoorBikeDataUtils.INSTANTANEOUS_CADENCE_RESOLUTION * BLEUtils.createUInt16(data, 2), IndoorBikeDataUtils.getInstantaneousCadenceRpm(BLEUtils.createUInt16(data, 2)), 0);
    }
    ...
    public void test_00302() {
        ...
        assertEquals(IndoorBikeDataUtils.AVERAGE_CADENCE_RESOLUTION * BLEUtils.createUInt16(data, 2), IndoorBikeDataUtils.getAverageCadenceRpm(BLEUtils.createUInt16(data, 2)), 0);
    }
    ...
    public void test_01002() {
        ...
        assertEquals(IndoorBikeDataUtils.METABOLIC_EQUIVALENT_RESOLUTION * BLEUtils.createUInt8(data, 2), IndoorBikeDataUtils.getMetabolicEquivalentWithUnit(BLEUtils.createUInt8(data, 2)), 0);
    }
