...
public class RowerDataUtilsTest extends TestBase {
    ...
    public void test_00001() {
        ...
        assertEquals(RowerDataUtils.STROKE_RATE_RESOLUTION * BLEUtils.createUInt8(data, 2), RowerDataUtils.getStrokeRateStrokePerMinute(BLEUtils.createUInt8(data, 2)), 0);
    }
    ...
    public void test_00102() {
        ...
        assertEquals(RowerDataUtils.AVERAGE_STROKE_RATE_RESOLUTION * BLEUtils.createUInt8(data, 2), RowerDataUtils.getAverageStrokeRateRpm(BLEUtils.createUInt8(data, 2)), 0);
    }
    ...
    public void test_01002() {
        ...
        assertEquals(RowerDataUtils.METABOLIC_EQUIVALENT_RESOLUTION * BLEUtils.createUInt8(data, 2), RowerDataUtils.getMetabolicEquivalentWithUnit(BLEUtils.createUInt8(data, 2)), 0);
    }
