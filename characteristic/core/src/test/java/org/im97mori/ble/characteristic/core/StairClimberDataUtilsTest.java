...
public class StairClimberDataUtilsTest extends TestBase {
    ...
    public void test_00702() {
        ...
        assertEquals(StairClimberDataUtils.METABOLIC_EQUIVALENT_RESOLUTION * BLEUtils.createUInt8(data, 2), StairClimberDataUtils.getMetabolicEquivalentWithUnit(BLEUtils.createUInt8(data, 2)), 0);
    }
