...
public class StepClimberDataUtilsTest extends TestBase {
    ...
    public void test_00602() {
        ...
        assertEquals(StepClimberDataUtils.METABOLIC_EQUIVALENT_RESOLUTION * BLEUtils.createUInt8(data, 2), StepClimberDataUtils.getMetabolicEquivalentWithUnit(BLEUtils.createUInt8(data, 2)), 0);
    }
