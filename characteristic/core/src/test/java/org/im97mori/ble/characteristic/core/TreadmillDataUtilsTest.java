...
public class TreadmillDataUtilsTest extends TestBase {
    ...
    public void test_00001() {
        ...
        assertEquals(TreadmillDataUtils.INSTANTANEOUS_SPEED_RESOLUTION * BLEUtils.createUInt16(data, 2), TreadmillDataUtils.getInstantaneousSpeedKilometerPerHour(BLEUtils.createUInt16(data, 2)), 0);
    }
    ...
    public void test_00102() {
        ...
        assertEquals(TreadmillDataUtils.AVERAGE_SPEED_RESOLUTION * BLEUtils.createUInt16(data, 4), TreadmillDataUtils.getAverageSpeedKilometerPerHour(BLEUtils.createUInt16(data, 4)), 0);
    }
    ...
    public void test_00302() {
        ...
        assertEquals(TreadmillDataUtils.INCLINATION_RESOLUTION * BLEUtils.createSInt16(data, 4), TreadmillDataUtils.getInclinationPercent(BLEUtils.createUInt16(data, 4)), 0);
        assertFalse(TreadmillDataUtils.isRampAngleSettingDataNotAvailable(BLEUtils.createSInt16(data, 6)));
        assertEquals(TreadmillDataUtils.RAMP_ANGLE_SETTING_RESOLUTION * BLEUtils.createSInt16(data, 6), TreadmillDataUtils.getRampAngleSettingDegree(BLEUtils.createSInt16(data, 6)), 0);
    }
    ...
    public void test_00402() {
        ...
        assertEquals(TreadmillDataUtils.POSITIVE_ELEVATION_GAIN_RESOLUTION * BLEUtils.createUInt16(data, 4), TreadmillDataUtils.getPositiveElevationGainMeters(BLEUtils.createUInt16(data, 4)), 0);
        assertEquals(TreadmillDataUtils.NEGATIVE_ELEVATION_GAIN_RESOLUTION * BLEUtils.createUInt16(data, 4), TreadmillDataUtils.getNegativeElevationGainMeters(BLEUtils.createUInt16(data, 4)), 0);
    }
    ...
    public void test_00502() {
        ...
        assertEquals(TreadmillDataUtils.INSTANTANEOUS_PACE_RESOLUTION * BLEUtils.createUInt8(data, 4), TreadmillDataUtils.getInstantaneousPaceKilometerPerMinute(BLEUtils.createUInt8(data, 4)), 0);
    }
    ...
    public void test_00602() {
        ...
        assertEquals(TreadmillDataUtils.AVERAGE_PACE_RESOLUTION * BLEUtils.createUInt8(data, 4), TreadmillDataUtils.getAveragePaceKilometerPerMinute(BLEUtils.createUInt8(data, 4)), 0);
    }
