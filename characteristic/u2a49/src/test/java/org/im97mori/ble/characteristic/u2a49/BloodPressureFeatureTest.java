...
public class BloodPressureFeatureTest extends TestBase {
	...
	public void test_constructor_2_00001() {
		...
		BloodPressureFeature result1 = new BloodPressureFeature(false, false, false, false, false, false, false, false,
				false);
		assertArrayEquals(data, result1.getBloodPressureFeature());
		assertFalse(result1.isBodyMovementDetectionSupported());
		assertTrue(result1.isBodyMovementDetectionNotSupported());
	...
	public void test_constructor_2_00002() {
		...
		BloodPressureFeature result1 = new BloodPressureFeature(true, false, false, false, false, false, false, false,
				false);
		assertArrayEquals(data, result1.getBloodPressureFeature());
		assertTrue(result1.isBodyMovementDetectionSupported());
		assertFalse(result1.isBodyMovementDetectionNotSupported());
	...
	public void test_constructor_2_00003() {
		...
		BloodPressureFeature result1 = new BloodPressureFeature(false, true, false, false, false, false, false, false,
				false);
		assertArrayEquals(data, result1.getBloodPressureFeature());
		assertFalse(result1.isBodyMovementDetectionSupported());
		assertTrue(result1.isBodyMovementDetectionNotSupported());
	...
	public void test_constructor_2_00004() {
		...
		BloodPressureFeature result1 = new BloodPressureFeature(false, false, true, false, false, false, false, false,
				false);
		assertArrayEquals(data, result1.getBloodPressureFeature());
		assertFalse(result1.isBodyMovementDetectionSupported());
		assertTrue(result1.isBodyMovementDetectionNotSupported());
	...
	public void test_constructor_2_00005() {
		...
		BloodPressureFeature result1 = new BloodPressureFeature(false, false, false, true, false, false, false, false,
				false);
		assertArrayEquals(data, result1.getBloodPressureFeature());
		assertFalse(result1.isBodyMovementDetectionSupported());
		assertTrue(result1.isBodyMovementDetectionNotSupported());
	...
	public void test_constructor_2_00006() {
		...
		BloodPressureFeature result1 = new BloodPressureFeature(false, false, false, false, true, false, false, false,
				false);
		assertArrayEquals(data, result1.getBloodPressureFeature());
		assertFalse(result1.isBodyMovementDetectionSupported());
		assertTrue(result1.isBodyMovementDetectionNotSupported());
	...
	public void test_constructor_2_00007() {
		...
		BloodPressureFeature result1 = new BloodPressureFeature(false, false, false, false, false, true, false, false,
				false);
		assertArrayEquals(data, result1.getBloodPressureFeature());
		assertFalse(result1.isBodyMovementDetectionSupported());
		assertTrue(result1.isBodyMovementDetectionNotSupported());
	...
	public void test_constructor_2_00008() {
		...
		BloodPressureFeature result1 = new BloodPressureFeature(false, false, false, false, false, false, true, false,
				false);
		assertArrayEquals(data, result1.getBloodPressureFeature());
		assertFalse(result1.isBodyMovementDetectionSupported());
		assertTrue(result1.isBodyMovementDetectionNotSupported());
	...
	public void test_constructor_2_00009() {
		...
		BloodPressureFeature result1 = new BloodPressureFeature(false, false, false, false, false, false, false, true,
				false);
		assertArrayEquals(data, result1.getBloodPressureFeature());
		assertFalse(result1.isBodyMovementDetectionSupported());
		assertTrue(result1.isBodyMovementDetectionNotSupported());
