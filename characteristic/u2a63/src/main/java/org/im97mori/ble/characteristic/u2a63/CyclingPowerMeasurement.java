 ...
 */
public class CyclingPowerMeasurement implements ByteArrayInterface {
     ...
     */
    public CyclingPowerMeasurement(@NonNull byte[] values) {
        int index = 0;
    ...
    public CyclingPowerMeasurement(@NonNull byte[] flags, int instantaneousPower, int pedalPowerBalance, int accumulatedTorque, long wheelRevolutionDataCumulativeWheelRevolutions, int wheelRevolutionDataLastWheelEventTime, int crankRevolutionDataCumulativeCrankRevolutions, int crankRevolutionDataLastCrankEventTime, int extremeForceMagnitudesMaximumForceMagnitude, int extremeForceMagnitudesMinimumForceMagnitude, int extremeTorqueMagnitudesMaximumTorqueMagnitude, int extremeTorqueMagnitudesMinimumTorqueMagnitude, int extremeAnglesMaximumAngle, int extremeAnglesMinimumAngle, int topDeadSpotAngle, int bottomDeadSpotAngle, int accumulatedEnergy) {
        ...
        mPedalPowerBalance = pedalPowerBalance;
        mAccumulatedTorque = accumulatedTorque;
        mWheelRevolutionDataCumulativeWheelRevolutions = wheelRevolutionDataCumulativeWheelRevolutions;
        mWheelRevolutionDataLastWheelEventTime = wheelRevolutionDataLastWheelEventTime;
        ...
        mExtremeForceMagnitudesMaximumForceMagnitude = extremeForceMagnitudesMaximumForceMagnitude;
        mExtremeForceMagnitudesMinimumForceMagnitude = extremeForceMagnitudesMinimumForceMagnitude;
        mExtremeTorqueMagnitudesMaximumTorqueMagnitude = extremeTorqueMagnitudesMaximumTorqueMagnitude;
        mExtremeTorqueMagnitudesMinimumTorqueMagnitude = extremeTorqueMagnitudesMinimumTorqueMagnitude;
        mExtremeAnglesMaximumAngle = extremeAnglesMaximumAngle;
        mExtremeAnglesMinimumAngle = extremeAnglesMinimumAngle;
        mTopDeadSpotAngle = topDeadSpotAngle;
        mBottomDeadSpotAngle = bottomDeadSpotAngle;
        mAccumulatedEnergy = accumulatedEnergy;
    }
     ...
     * @param expect one of {@link #FLAGS_PEDAL_POWER_BALANCE_PRESENT_FALSE} , {@link #FLAGS_PEDAL_POWER_BALANCE_PRESENT_TRUE} , {@link #FLAGS_PEDAL_POWER_BALANCE_REFERENCE_UNKNOWN} , {@link #FLAGS_PEDAL_POWER_BALANCE_REFERENCE_LEFT} , {@link #FLAGS_ACCUMULATED_TORQUE_PRESENT_FALSE} , {@link #FLAGS_ACCUMULATED_TORQUE_PRESENT_TRUE} , {@link #FLAGS_ACCUMULATED_TORQUE_SOURCE_WHEEL_BASED} , {@link #FLAGS_ACCUMULATED_TORQUE_SOURCE_CRANK_BASED} , {@link #FLAGS_WHEEL_REVOLUTION_DATA_PRESENT_FALSE} , {@link #FLAGS_WHEEL_REVOLUTION_DATA_PRESENT_TRUE} , {@link #FLAGS_CRANK_REVOLUTION_DATA_PRESENT_FALSE} , {@link #FLAGS_CRANK_REVOLUTION_DATA_PRESENT_TRUE} , {@link #FLAGS_EXTREME_FORCE_MAGNITUDES_PRESENT_FALSE} , {@link #FLAGS_EXTREME_FORCE_MAGNITUDES_PRESENT_TRUE} , {@link #FLAGS_EXTREME_TORQUE_MAGNITUDES_PRESENT_FALSE} , {@link #FLAGS_EXTREME_TORQUE_MAGNITUDES_PRESENT_TRUE} , {@link #FLAGS_EXTREME_ANGLES_PRESENT_FALSE} , {@link #FLAGS_EXTREME_ANGLES_PRESENT_TRUE} , {@link #FLAGS_TOP_DEAD_SPOT_ANGLE_PRESENT_FALSE} , {@link #FLAGS_TOP_DEAD_SPOT_ANGLE_PRESENT_TRUE} , {@link #FLAGS_BOTTOM_DEAD_SPOT_ANGLE_PRESENT_FALSE} , {@link #FLAGS_BOTTOM_DEAD_SPOT_ANGLE_PRESENT_TRUE} , {@link #FLAGS_ACCUMULATED_ENERGY_PRESENT_FALSE} , {@link #FLAGS_ACCUMULATED_ENERGY_PRESENT_TRUE} , {@link #FLAGS_OFFSET_COMPENSATION_INDICATION_FALSE} , {@link #FLAGS_OFFSET_COMPENSATION_INDICATION_TRUE}
