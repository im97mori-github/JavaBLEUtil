...
public class CyclingPowerMeasurementTest extends TestBase {
    ...
    public void test_constructor_00001() {
        ...
        CyclingPowerMeasurement result1 = new CyclingPowerMeasurement(data);
