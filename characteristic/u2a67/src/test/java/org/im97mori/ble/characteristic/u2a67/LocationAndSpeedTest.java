...
public class LocationAndSpeedTest extends TestBase {
    ...
    public void test_constructor039() {
        ...
        LocationAndSpeed result1 = new LocationAndSpeed(flags, instantaneousSpeed, totalDistance, locationLatitude, locationLongitude, elevation, heading, rollingTime, year, month, day, hours, minutes, seconds);
