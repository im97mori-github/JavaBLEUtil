...
public class LNControlPointTest extends TestBase {
    ...
    public void test_constructor058() {
        ...
        LNControlPoint result1 = new LNControlPoint(opCodes, parameterValue, requestOpCode, responseValue, responseParameter);
