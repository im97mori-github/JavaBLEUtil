 ...
 */
public class DateOfThresholdAssessment implements ByteArrayInterface {
     ...
     */
    public DateOfThresholdAssessment(@NonNull byte[] values) {
     ...
     * @param day   Day
     */
    public DateOfThresholdAssessment(int year, int month, int day) {
        mYear = year;
        mMonth = month;
        mDay = day;
    }
