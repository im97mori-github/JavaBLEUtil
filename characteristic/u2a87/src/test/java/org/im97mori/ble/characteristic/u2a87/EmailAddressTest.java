...
public class EmailAddressTest extends TestBase {
	...
	public void test_constructor_00002() {
		...
		EmailAddress result1 = new EmailAddress(registeredUsers);
		assertEquals(
				new String(emailAddress1) + new String(emailAddress2),
				result1.getEmailAddress());
	}
	...
	public void test_constructor_00003() {
		...
		EmailAddress result1 = new EmailAddress(registeredUsers);
		assertEquals(new String(emailAddress1)
				+ new String(emailAddress2) + new String(emailAddress3),
				result1.getEmailAddress());
	}
	...
	public void test_parcelable_2_00003() {
		...
		System.arraycopy(emailAddress1, 0, merged, 3, emailAddress1.length);
		System.arraycopy(emailAddress2, 0, merged, 3 + emailAddress1.length, emailAddress2.length);
		System.arraycopy(emailAddress3, 0, merged, 3 + emailAddress1.length + emailAddress2.length,
				emailAddress3.length);
