...
public class FirstNameTest {
    ...
    public void test_constructor_00002() {
        ...
        FirstName result1 = new FirstName(registeredUsers);
        assertEquals(new String(FirstName1) + new String(FirstName2), result1.getFirstName());
    }
    ...
    public void test_constructor_00003() {
        ...
        FirstName result1 = new FirstName(registeredUsers);
        assertEquals(new String(FirstName1) + new String(FirstName2) + new String(FirstName3), result1.getFirstName());
    }
