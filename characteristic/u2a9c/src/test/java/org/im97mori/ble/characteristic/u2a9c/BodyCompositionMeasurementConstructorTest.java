...
public class BodyCompositionMeasurementConstructorTest {
    ...
    public void test_constructor002() {
        ...
        BodyCompositionMeasurement result1 = new BodyCompositionMeasurement(new BodyCompositionMeasurementPacket[] { new BodyCompositionMeasurementPacket(data1), new BodyCompositionMeasurementPacket(data2) });
    ...
    public void test_constructor003() {
        ...
        BodyCompositionMeasurement result1 = new BodyCompositionMeasurement(
