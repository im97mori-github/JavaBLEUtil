...
public class OtsFeatureTest extends TestBase {
	...
	public void test_constructor_1_00001() {
		...
		OtsFeature result1 = new OtsFeature(data);
	...
	public void test_constructor_2_00001() {
		...
		OtsFeature result1 = new OtsFeature(false, false, false, false, false, false, false, false, false, false, false,
				false, false, false);
		assertArrayEquals(Arrays.copyOfRange(data, 0, 4), result1.getOacpFeatures());
		assertTrue(result1.isOacpCreateOpCodeNotSupported());
		assertFalse(result1.isOacpCreateOpCodeSupported());
	...
	public void test_constructor_2_00002() {
		...
		OtsFeature result1 = new OtsFeature(true, false, false, false, false, false, false, false, false, false, false,
				false, false, false);
		assertArrayEquals(Arrays.copyOfRange(data, 0, 4), result1.getOacpFeatures());
		assertFalse(result1.isOacpCreateOpCodeNotSupported());
		assertTrue(result1.isOacpCreateOpCodeSupported());
	...
	public void test_constructor_2_00003() {
		...
		OtsFeature result1 = new OtsFeature(false, true, false, false, false, false, false, false, false, false, false,
				false, false, false);
		assertArrayEquals(Arrays.copyOfRange(data, 0, 4), result1.getOacpFeatures());
		assertTrue(result1.isOacpCreateOpCodeNotSupported());
		assertFalse(result1.isOacpCreateOpCodeSupported());
	...
	public void test_constructor_2_00004() {
		...
		OtsFeature result1 = new OtsFeature(false, false, true, false, false, false, false, false, false, false, false,
				false, false, false);
		assertArrayEquals(Arrays.copyOfRange(data, 0, 4), result1.getOacpFeatures());
		assertTrue(result1.isOacpCreateOpCodeNotSupported());
		assertFalse(result1.isOacpCreateOpCodeSupported());
	...
	public void test_constructor_2_00005() {
		...
		OtsFeature result1 = new OtsFeature(false, false, false, true, false, false, false, false, false, false, false,
				false, false, false);
		assertArrayEquals(Arrays.copyOfRange(data, 0, 4), result1.getOacpFeatures());
		assertTrue(result1.isOacpCreateOpCodeNotSupported());
		assertFalse(result1.isOacpCreateOpCodeSupported());
	...
	public void test_constructor_2_00006() {
		...
		OtsFeature result1 = new OtsFeature(false, false, false, false, true, false, false, false, false, false, false,
				false, false, false);
		assertArrayEquals(Arrays.copyOfRange(data, 0, 4), result1.getOacpFeatures());
		assertTrue(result1.isOacpCreateOpCodeNotSupported());
		assertFalse(result1.isOacpCreateOpCodeSupported());
	...
	public void test_constructor_2_00007() {
		...
		OtsFeature result1 = new OtsFeature(false, false, false, false, false, true, false, false, false, false, false,
				false, false, false);
		assertArrayEquals(Arrays.copyOfRange(data, 0, 4), result1.getOacpFeatures());
		assertTrue(result1.isOacpCreateOpCodeNotSupported());
		assertFalse(result1.isOacpCreateOpCodeSupported());
	...
	public void test_constructor_2_00008() {
		...
		OtsFeature result1 = new OtsFeature(false, false, false, false, false, false, true, false, false, false, false,
				false, false, false);
		assertArrayEquals(Arrays.copyOfRange(data, 0, 4), result1.getOacpFeatures());
		assertTrue(result1.isOacpCreateOpCodeNotSupported());
		assertFalse(result1.isOacpCreateOpCodeSupported());
	...
	public void test_constructor_2_00009() {
		...
		OtsFeature result1 = new OtsFeature(false, false, false, false, false, false, false, true, false, false, false,
				false, false, false);
		assertArrayEquals(Arrays.copyOfRange(data, 0, 4), result1.getOacpFeatures());
		assertTrue(result1.isOacpCreateOpCodeNotSupported());
		assertFalse(result1.isOacpCreateOpCodeSupported());
	...
	public void test_constructor_2_00010() {
		...
		OtsFeature result1 = new OtsFeature(false, false, false, false, false, false, false, false, true, false, false,
				false, false, false);
		assertArrayEquals(Arrays.copyOfRange(data, 0, 4), result1.getOacpFeatures());
		assertTrue(result1.isOacpCreateOpCodeNotSupported());
		assertFalse(result1.isOacpCreateOpCodeSupported());
	...
	public void test_constructor_2_00011() {
		...
		OtsFeature result1 = new OtsFeature(false, false, false, false, false, false, false, false, false, true, false,
				false, false, false);
		assertArrayEquals(Arrays.copyOfRange(data, 0, 4), result1.getOacpFeatures());
		assertTrue(result1.isOacpCreateOpCodeNotSupported());
		assertFalse(result1.isOacpCreateOpCodeSupported());
	...
	public void test_constructor_2_00012() {
		...
		OtsFeature result1 = new OtsFeature(false, false, false, false, false, false, false, false, false, false, true,
				false, false, false);
		assertArrayEquals(Arrays.copyOfRange(data, 0, 4), result1.getOacpFeatures());
		assertTrue(result1.isOacpCreateOpCodeNotSupported());
		assertFalse(result1.isOacpCreateOpCodeSupported());
