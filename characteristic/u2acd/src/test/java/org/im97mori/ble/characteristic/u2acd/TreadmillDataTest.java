...
public class TreadmillDataTest extends TestBase {
    ...
    public void test_constructor_00001() {
        ...
        TreadmillData result1 = new TreadmillData(new TreadmillDataPacket[] { new TreadmillDataPacket(data) });
    ...
    public void test_constructor_00002() {
        ...
        TreadmillData result1 = new TreadmillData(new TreadmillDataPacket[] { new TreadmillDataPacket(data1), new TreadmillDataPacket(data2) });
