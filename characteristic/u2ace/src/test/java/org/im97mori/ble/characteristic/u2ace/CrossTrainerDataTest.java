...
public class CrossTrainerDataTest extends TestBase {
    ...
    public void test_constructor_00001() {
        ...
        CrossTrainerData result1 = new CrossTrainerData(new CrossTrainerDataPacket[] { new CrossTrainerDataPacket(data) });
    ...
    public void test_constructor_00002() {
        ...
        CrossTrainerData result1 = new CrossTrainerData(new CrossTrainerDataPacket[] { new CrossTrainerDataPacket(data1), new CrossTrainerDataPacket(data2) });
    ...
    public void test_constructor_00003() {
        ...
        CrossTrainerData result1 = new CrossTrainerData(flags, instantaneousSpeed, averageSpeed, totalDistance, stepPerMinute, averageStepRate, strideCount, positiveElevationGain, negativeElevationGain, inclination, rampAngleSetting, resistanceLevel, instantaneousPower, averagePower, totalEnergy, energyPerHour, energyPerMinute, heartRate, metabolicEquivalent, elapsedTime, remainingTime);
