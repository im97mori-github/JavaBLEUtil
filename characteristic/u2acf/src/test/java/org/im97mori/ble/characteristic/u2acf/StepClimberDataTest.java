...
public class StepClimberDataTest extends TestBase {
    ...
    public void test_constructor_00001() {
        ...
        StepClimberData result1 = new StepClimberData(new StepClimberDataPacket[] { new StepClimberDataPacket(data) });
    ...
    public void test_constructor_00002() {
        ...
        StepClimberData result1 = new StepClimberData(new StepClimberDataPacket[] { new StepClimberDataPacket(data1), new StepClimberDataPacket(data2) });
    ...
    public void test_constructor_00003() {
        ...
        StepClimberData result1 = new StepClimberData(flags, floors, stepCount, stepPerMinute, averageStepRate, positiveElevationGain, totalEnergy, energyPerHour, energyPerMinute, heartRate, metabolicEquivalent, elapsedTime, remainingTime);
