...
public class StairClimberDataPacketTest extends TestBase {
    ...
    public void test_constructor_00903() {
        ...
        StairClimberDataPacket result1 = new StairClimberDataPacket(flags, floors, stepPerMinute, averageStepRate, positiveElevationGain, strideCount, totalEnergy, energyPerHour, energyPerMinute, heartRate, metabolicEquivalent, elapsedTime, remainingTime);
