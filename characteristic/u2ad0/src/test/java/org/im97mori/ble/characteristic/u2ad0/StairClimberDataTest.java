...
public class StairClimberDataTest extends TestBase {
    ...
    public void test_constructor_00003() {
        ...
        StairClimberData result1 = new StairClimberData(flags, floors, stepPerMinute, averageStepRate, positiveElevationGain, strideCount, totalEnergy, energyPerHour, energyPerMinute, heartRate, metabolicEquivalent, elapsedTime, remainingTime);
