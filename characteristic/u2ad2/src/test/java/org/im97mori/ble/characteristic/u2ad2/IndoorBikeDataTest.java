...
public class IndoorBikeDataTest extends TestBase {
    ...
    public void test_constructor_00001() {
        ...
        IndoorBikeData result1 = new IndoorBikeData(new IndoorBikeDataPacket[] { new IndoorBikeDataPacket(data) });
    ...
    public void test_constructor_00002() {
        ...
        IndoorBikeData result1 = new IndoorBikeData(new IndoorBikeDataPacket[] { new IndoorBikeDataPacket(data1), new IndoorBikeDataPacket(data2) });
    ...
    public void test_constructor_01204() {
        ...
        IndoorBikeData result1 = new IndoorBikeData(flags, instantaneousSpeed, averageSpeed, instantaneousCadence, averageCadence, totalDistance, resistanceLevel, instantaneousPower, averagePower, totalEnergy, energyPerHour, energyPerMinute, heartRate, metabolicEquivalent, elapsedTime, remainingTime);
