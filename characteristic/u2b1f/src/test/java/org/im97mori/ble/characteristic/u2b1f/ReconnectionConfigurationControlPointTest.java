...
public class ReconnectionConfigurationControlPointTest extends TestBase {
    ...
    private static final byte[] data_01405;
    static {
        byte[] data = new byte[18];
        data[ 0] = ReconnectionConfigurationControlPoint.OPCODE_COMMUNICATION_PARAMETER_RESPONSE;
        data[ 1] = ReconnectionConfigurationControlPoint.OPCODE_GET_MAX_VALUES;
        data[ 2] = (byte) ReconnectionConfigurationControlPoint.PARAMETER_NOT_SUPPORTED;
        data[ 3] = (byte) (ReconnectionConfigurationControlPoint.PARAMETER_NOT_SUPPORTED >> 8);
        data[ 4] = 0x03;
        data[ 5] = 0x04;
        data[ 6] = 0x05;
        data[ 7] = 0x06;
    ...
    private static final byte[] data_01406;
    static {
        byte[] data = new byte[18];
        data[ 0] = ReconnectionConfigurationControlPoint.OPCODE_COMMUNICATION_PARAMETER_RESPONSE;
        data[ 1] = ReconnectionConfigurationControlPoint.OPCODE_GET_MAX_VALUES;
        data[ 2] = 0x01;
        data[ 3] = 0x02;
        data[ 4] = (byte) ReconnectionConfigurationControlPoint.PARAMETER_NOT_SUPPORTED;
        data[ 5] = (byte) (ReconnectionConfigurationControlPoint.PARAMETER_NOT_SUPPORTED >> 8);
        data[ 6] = 0x05;
        data[ 7] = 0x06;
        data[ 8] = 0x07;
        data[ 9] = 0x08;
    ...
    private static final byte[] data_01407;
    static {
        byte[] data = new byte[18];
        data[ 0] = ReconnectionConfigurationControlPoint.OPCODE_COMMUNICATION_PARAMETER_RESPONSE;
        data[ 1] = ReconnectionConfigurationControlPoint.OPCODE_GET_MAX_VALUES;
        ...
        data[ 4] = 0x03;
        data[ 5] = 0x04;
        data[ 6] = (byte) ReconnectionConfigurationControlPoint.PARAMETER_NOT_SUPPORTED;
        data[ 7] = (byte) (ReconnectionConfigurationControlPoint.PARAMETER_NOT_SUPPORTED >> 8);
        data[ 8] = 0x07;
        data[ 9] = 0x08;
        data[10] = 0x09;
        data[11] = 0x0a;
    ...
    private static final byte[] data_01408;
    static {
        byte[] data = new byte[18];
        data[ 0] = ReconnectionConfigurationControlPoint.OPCODE_COMMUNICATION_PARAMETER_RESPONSE;
        data[ 1] = ReconnectionConfigurationControlPoint.OPCODE_GET_MAX_VALUES;
        ...
        data[ 6] = 0x05;
        data[ 7] = 0x06;
        data[ 8] = (byte) ReconnectionConfigurationControlPoint.PARAMETER_NOT_SUPPORTED;
        data[ 9] = (byte) (ReconnectionConfigurationControlPoint.PARAMETER_NOT_SUPPORTED >> 8);
        data[10] = 0x09;
        data[11] = 0x0a;
        data[12] = 0x0b;
        data[13] = 0x0c;
    ...
    private static final byte[] data_01409;
    static {
        byte[] data = new byte[18];
        data[ 0] = ReconnectionConfigurationControlPoint.OPCODE_COMMUNICATION_PARAMETER_RESPONSE;
        data[ 1] = ReconnectionConfigurationControlPoint.OPCODE_GET_MAX_VALUES;
        ...
        data[ 8] = 0x07;
        data[ 9] = 0x08;
        data[10] = (byte) ReconnectionConfigurationControlPoint.PARAMETER_NOT_SUPPORTED;
        data[11] = (byte) (ReconnectionConfigurationControlPoint.PARAMETER_NOT_SUPPORTED >> 8);
        data[12] = 0x0b;
        data[13] = 0x0c;
        data[14] = 0x0d;
        data[15] = 0x0e;
    ...
    private static final byte[] data_01410;
    static {
        byte[] data = new byte[18];
        data[ 0] = ReconnectionConfigurationControlPoint.OPCODE_COMMUNICATION_PARAMETER_RESPONSE;
        data[ 1] = ReconnectionConfigurationControlPoint.OPCODE_GET_MAX_VALUES;
        ...
        data[10] = 0x09;
        data[11] = 0x0a;
        data[12] = (byte) ReconnectionConfigurationControlPoint.PARAMETER_NOT_SUPPORTED;
        data[13] = (byte) (ReconnectionConfigurationControlPoint.PARAMETER_NOT_SUPPORTED >> 8);
        data[14] = 0x0d;
        data[15] = 0x0e;
        data[16] = 0x0f;
        data[17] = 0x10;
    ...
    private static final byte[] data_01411;
    static {
        byte[] data = new byte[18];
        data[ 0] = ReconnectionConfigurationControlPoint.OPCODE_COMMUNICATION_PARAMETER_RESPONSE;
        data[ 1] = ReconnectionConfigurationControlPoint.OPCODE_GET_MAX_VALUES;
        ...
        data[12] = 0x0b;
        data[13] = 0x0c;
        data[14] = (byte) ReconnectionConfigurationControlPoint.PARAMETER_NOT_SUPPORTED;
        data[15] = (byte) (ReconnectionConfigurationControlPoint.PARAMETER_NOT_SUPPORTED >> 8);
        data[16] = 0x0f;
        data[17] = 0x10;
        data_01411 = data;
    }

    private static final byte[] data_01412;
    static {
        byte[] data = new byte[18];
        data[ 0] = ReconnectionConfigurationControlPoint.OPCODE_COMMUNICATION_PARAMETER_RESPONSE;
        data[ 1] = ReconnectionConfigurationControlPoint.OPCODE_GET_MAX_VALUES;
        ...
        data[14] = 0x0d;
        data[15] = 0x0e;
        data[16] = (byte) ReconnectionConfigurationControlPoint.PARAMETER_NOT_SUPPORTED;
        data[17] = (byte) (ReconnectionConfigurationControlPoint.PARAMETER_NOT_SUPPORTED >> 8);
        data_01412 = data;
    }
    ...
    public void test_constructor_00001() {
        ...
        ReconnectionConfigurationControlPoint result1 = new ReconnectionConfigurationControlPoint(data);
    ...
    public void test_constructor_01401() {
        ...
        assertFalse(result1.isReconnectionTimeoutNotBeChanged());
        assertFalse(result1.isReconnectionTimeoutDisabled());
        assertFalse(result1.isReconnectionTimeoutNotSupported());
        assertEquals(0x0403, result1.getMinimumConnectionInterval());
        assertEquals(ReconnectionConfigurationControlPoint.MINIMUM_CONNECTION_INTERVAL_RESOLUTION * 0x0403, result1.getMinimumConnectionIntervalMs(), 0);
        assertFalse(result1.isMinimumConnectionIntervalNotBeChanged());
        assertFalse(result1.isMinimumConnectionIntervalNotSupported());
        assertEquals(0x0605, result1.getMaximumConnectionInterval());
        assertEquals(ReconnectionConfigurationControlPoint.MAXIMUM_CONNECTION_INTERVAL_RESOLUTION * 0x0605, result1.getMaximumConnectionIntervalMs(), 0);
        assertFalse(result1.isMaximumConnectionIntervalNotBeChanged());
        assertFalse(result1.isMaximumConnectionIntervalNotSupported());
        assertEquals(0x0807, result1.getSlaveLatency());
        assertFalse(result1.isSlaveLatencyNotBeChanged());
        assertFalse(result1.isSlaveLatencyNotSupported());
        assertEquals(0x0a09, result1.getSupervisionTimeoutMultiplier());
        assertEquals(ReconnectionConfigurationControlPoint.SUPERVISION_TIMEOUT_MULTIPLIER_RESOLUTION * 0x0a09, result1.getSupervisionTimeoutMultiplierMs(), 0);
        assertFalse(result1.isSupervisionTimeoutMultiplierNotBeChanged());
        assertFalse(result1.isSupervisionTimeoutMultiplierNotSupported());
        assertEquals(0x0c0b, result1.getAdvertisementInterval());
        assertEquals(ReconnectionConfigurationControlPoint.ADVERTISEMENT_INTERVAL_RESOLUTION * 0x0c0b, result1.getAdvertisementIntervalMs(), 0);
        assertFalse(result1.isAdvertisementIntervalNotBeChanged());
        assertFalse(result1.isAdvertisementIntervalNotSupported());
        assertEquals(0x0e0d, result1.getAdvertisementCount());
        assertFalse(result1.isAdvertisementCountNotBeChanged());
        assertFalse(result1.isAdvertisementCountNotSupported());
        assertEquals(0x100f, result1.getAdvertisementRepetitionTime());
        assertFalse(result1.isAdvertisementRepetitionTimeNotBeChanged());
        assertFalse(result1.isAdvertisementRepetitionNotSupported());
    ...
    @Test
    public void test_constructor_01405() {
        byte[] data = getData();
        ...
        assertFalse(result1.isOpcodeWhiteListTimerResponse(result1.getRequestOpcodes()));
        assertFalse(result1.isOpcodeClientParameterIndication(result1.getRequestOpcodes()));
        assertEquals(ReconnectionConfigurationControlPoint.PARAMETER_NOT_SUPPORTED, result1.getReconnectionTimeout());
        assertFalse(result1.isReconnectionTimeoutNotBeChanged());
        assertFalse(result1.isReconnectionTimeoutDisabled());
        assertTrue(result1.isReconnectionTimeoutNotSupported());
        assertEquals(0x0403, result1.getMinimumConnectionInterval());
        assertEquals(ReconnectionConfigurationControlPoint.MINIMUM_CONNECTION_INTERVAL_RESOLUTION * 0x0403, result1.getMinimumConnectionIntervalMs(), 0);
        assertFalse(result1.isMinimumConnectionIntervalNotBeChanged());
        assertFalse(result1.isMinimumConnectionIntervalNotSupported());
    ...
    @Test
    public void test_constructor_01406() {
        byte[] data = getData();
        ...
        assertFalse(result1.isReconnectionTimeoutDisabled());
        assertFalse(result1.isReconnectionTimeoutNotSupported());
        assertEquals(ReconnectionConfigurationControlPoint.PARAMETER_NOT_SUPPORTED, result1.getMinimumConnectionInterval());
        assertEquals(ReconnectionConfigurationControlPoint.MINIMUM_CONNECTION_INTERVAL_RESOLUTION * ReconnectionConfigurationControlPoint.PARAMETER_NOT_SUPPORTED, result1.getMinimumConnectionIntervalMs(), 0);
        assertFalse(result1.isMinimumConnectionIntervalNotBeChanged());
        assertTrue(result1.isMinimumConnectionIntervalNotSupported());
        assertEquals(0x0605, result1.getMaximumConnectionInterval());
        assertEquals(ReconnectionConfigurationControlPoint.MAXIMUM_CONNECTION_INTERVAL_RESOLUTION * 0x0605, result1.getMaximumConnectionIntervalMs(), 0);
        assertFalse(result1.isMaximumConnectionIntervalNotBeChanged());
        assertFalse(result1.isMaximumConnectionIntervalNotSupported());
    ...
    @Test
    public void test_constructor_01407() {
        byte[] data = getData();
        ...
        assertFalse(result1.isMinimumConnectionIntervalNotBeChanged());
        assertFalse(result1.isMinimumConnectionIntervalNotSupported());
        assertEquals(ReconnectionConfigurationControlPoint.PARAMETER_NOT_SUPPORTED, result1.getMaximumConnectionInterval());
        assertEquals(ReconnectionConfigurationControlPoint.MAXIMUM_CONNECTION_INTERVAL_RESOLUTION * ReconnectionConfigurationControlPoint.PARAMETER_NOT_SUPPORTED, result1.getMaximumConnectionIntervalMs(), 0);
        assertFalse(result1.isMaximumConnectionIntervalNotBeChanged());
        assertTrue(result1.isMaximumConnectionIntervalNotSupported());
        assertEquals(0x0807, result1.getSlaveLatency());
        assertFalse(result1.isSlaveLatencyNotBeChanged());
        assertFalse(result1.isSlaveLatencyNotSupported());
        assertEquals(0x0a09, result1.getSupervisionTimeoutMultiplier());
    ...
    @Test
    public void test_constructor_01408() {
        byte[] data = getData();
        ...
        assertFalse(result1.isMaximumConnectionIntervalNotBeChanged());
        assertFalse(result1.isMaximumConnectionIntervalNotSupported());
        assertEquals(ReconnectionConfigurationControlPoint.PARAMETER_NOT_SUPPORTED, result1.getSlaveLatency());
        assertFalse(result1.isSlaveLatencyNotBeChanged());
        assertTrue(result1.isSlaveLatencyNotSupported());
        assertEquals(0x0a09, result1.getSupervisionTimeoutMultiplier());
        assertEquals(ReconnectionConfigurationControlPoint.SUPERVISION_TIMEOUT_MULTIPLIER_RESOLUTION * 0x0a09, result1.getSupervisionTimeoutMultiplierMs(), 0);
        assertFalse(result1.isSupervisionTimeoutMultiplierNotBeChanged());
        assertFalse(result1.isSupervisionTimeoutMultiplierNotSupported());
    ...
    @Test
    public void test_constructor_01409() {
        byte[] data = getData();
        ...
        assertFalse(result1.isSlaveLatencyNotBeChanged());
        assertFalse(result1.isSlaveLatencyNotSupported());
        assertEquals(ReconnectionConfigurationControlPoint.PARAMETER_NOT_SUPPORTED, result1.getSupervisionTimeoutMultiplier());
        assertEquals(ReconnectionConfigurationControlPoint.SUPERVISION_TIMEOUT_MULTIPLIER_RESOLUTION * ReconnectionConfigurationControlPoint.PARAMETER_NOT_SUPPORTED, result1.getSupervisionTimeoutMultiplierMs(), 0);
        assertFalse(result1.isSupervisionTimeoutMultiplierNotBeChanged());
        assertTrue(result1.isSupervisionTimeoutMultiplierNotSupported());
        assertEquals(0x0c0b, result1.getAdvertisementInterval());
        assertEquals(ReconnectionConfigurationControlPoint.ADVERTISEMENT_INTERVAL_RESOLUTION * 0x0c0b, result1.getAdvertisementIntervalMs(), 0);
        assertFalse(result1.isAdvertisementIntervalNotBeChanged());
        assertFalse(result1.isAdvertisementIntervalNotSupported());
    ...
    @Test
    public void test_constructor_01410() {
        byte[] data = getData();
        ...
        assertFalse(result1.isSupervisionTimeoutMultiplierNotBeChanged());
        assertFalse(result1.isSupervisionTimeoutMultiplierNotSupported());
        assertEquals(ReconnectionConfigurationControlPoint.PARAMETER_NOT_SUPPORTED, result1.getAdvertisementInterval());
        assertEquals(ReconnectionConfigurationControlPoint.ADVERTISEMENT_INTERVAL_RESOLUTION * ReconnectionConfigurationControlPoint.PARAMETER_NOT_SUPPORTED, result1.getAdvertisementIntervalMs(), 0);
        assertFalse(result1.isAdvertisementIntervalNotBeChanged());
        assertTrue(result1.isAdvertisementIntervalNotSupported());
        assertEquals(0x0e0d, result1.getAdvertisementCount());
        assertFalse(result1.isAdvertisementCountNotBeChanged());
        assertFalse(result1.isAdvertisementCountNotSupported());
        assertEquals(0x100f, result1.getAdvertisementRepetitionTime());
    ...
    @Test
    public void test_constructor_01411() {
        byte[] data = getData();
        ...
        assertFalse(result1.isAdvertisementIntervalNotBeChanged());
        assertFalse(result1.isAdvertisementIntervalNotSupported());
        assertEquals(ReconnectionConfigurationControlPoint.PARAMETER_NOT_SUPPORTED, result1.getAdvertisementCount());
        assertFalse(result1.isAdvertisementCountNotBeChanged());
        assertTrue(result1.isAdvertisementCountNotSupported());
        assertEquals(0x100f, result1.getAdvertisementRepetitionTime());
        assertFalse(result1.isAdvertisementRepetitionTimeNotBeChanged());
        assertFalse(result1.isAdvertisementRepetitionNotSupported());
        assertArrayEquals(Arrays.copyOfRange(data, 2, 18), result1.getResultParameter());
    ...
    @Test
    public void test_constructor_01412() {
        byte[] data = getData();
        ...
        assertFalse(result1.isAdvertisementCountNotBeChanged());
        assertFalse(result1.isAdvertisementCountNotSupported());
        assertEquals(ReconnectionConfigurationControlPoint.PARAMETER_NOT_SUPPORTED, result1.getAdvertisementRepetitionTime());
        assertFalse(result1.isAdvertisementRepetitionTimeNotBeChanged());
        assertTrue(result1.isAdvertisementRepetitionNotSupported());
        assertArrayEquals(Arrays.copyOfRange(data, 2, 18), result1.getResultParameter());
    }
    ...
    public void test_constructor_01604() {
        ...
        ReconnectionConfigurationControlPoint result1 = new ReconnectionConfigurationControlPoint(opcode, operand, e2eCrc, requestOpcodes, resultCode, resultParameter);
