...
public class BloodPressureRecordTest {
	...
	public void test_constructor_1_00001() {
		...
		BloodPressureRecordPacket packet1 = new BloodPressureRecordPacket(data);
		BloodPressureRecord result1 = new BloodPressureRecord(packet1);
	...
	public void test_constructor_1_00002() {
		...
		data[2] = 0x0a;
		data[3] = 0x0b;
		BloodPressureRecordPacket packet2 = new BloodPressureRecordPacket(data);

		BloodPressureRecord result1 = new BloodPressureRecord(packet1, packet2);
		assertEquals(packet1.getSequenceNumber(), result1.getSequenceNumber());
		assertEquals(packet1.getUuid(), result1.getUuid());
	...
	public void test_constructor_1_00003() {
		...
		data[2] = 0x0c;
		data[3] = 0x0d;
		BloodPressureRecordPacket packet3 = new BloodPressureRecordPacket(data);

		BloodPressureRecord result1 = new BloodPressureRecord(packet1, packet2, packet3);
		assertEquals(packet1.getSequenceNumber(), result1.getSequenceNumber());
		assertEquals(packet1.getUuid(), result1.getUuid());
	...
	public void test_constructor_2_00001() {
		...
		BloodPressureRecord result1 = new BloodPressureRecord(sequenceNumber, uuid, recordedCharacteristic, crc);
