...
public class CharacteristicUUIDTest extends TestBase {
	...
	public void test_map_00001() {
		...
		assertEquals("Peripheral Preferred Connection Parameters", CHARACTERISTIC_MAPPING_128.get(PERIPHERAL_PREFERRED_CONNECTION_PARAMETERS_CHARACTERISTIC));
		...
		assertEquals("Reference Time Information", CHARACTERISTIC_MAPPING_128.get(REFERENCE_TIME_INFORMATION_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(TIME_UPDATE_CONTROL_POINT_CHARACTERISTIC));
		assertEquals("Time Update Control Point", CHARACTERISTIC_MAPPING_128.get(TIME_UPDATE_CONTROL_POINT_CHARACTERISTIC));
		...
		assertEquals("Intermediate Temperature", CHARACTERISTIC_MAPPING_128.get(INTERMEDIATE_TEMPERATURE_CHARACTERISTIC));
		...
		assertEquals("Boot Keyboard Input Report", CHARACTERISTIC_MAPPING_128.get(BOOT_KEYBOARD_INPUT_REPORT_CHARACTERISTIC));
		...
		assertEquals("Firmware Revision String", CHARACTERISTIC_MAPPING_128.get(FIRMWARE_REVISION_STRING_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(HARDWARE_REVISION_STRING_CHARACTERISTIC));
		assertEquals("Hardware Revision String", CHARACTERISTIC_MAPPING_128.get(HARDWARE_REVISION_STRING_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(SOFTWARE_REVISION_STRING_CHARACTERISTIC));
		assertEquals("Software Revision String", CHARACTERISTIC_MAPPING_128.get(SOFTWARE_REVISION_STRING_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(MANUFACTURER_NAME_STRING_CHARACTERISTIC));
		assertEquals("Manufacturer Name String", CHARACTERISTIC_MAPPING_128.get(MANUFACTURER_NAME_STRING_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(IEEE_11073_20601_REGULATORY_CERTIFICATION_DATA_LIST_CHARACTERISTIC));
		assertEquals("IEEE 11073-20601 Regulatory Certification Data List", CHARACTERISTIC_MAPPING_128.get(IEEE_11073_20601_REGULATORY_CERTIFICATION_DATA_LIST_CHARACTERISTIC));
		...
		assertEquals("Boot Keyboard Output Report", CHARACTERISTIC_MAPPING_128.get(BOOT_KEYBOARD_OUTPUT_REPORT_CHARACTERISTIC));
		...
		assertEquals("Glucose Measurement Context", CHARACTERISTIC_MAPPING_128.get(GLUCOSE_MEASUREMENT_CONTEXT_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(BLOOD_PRESSURE_MEASUREMENT_CHARACTERISTIC));
		assertEquals("Blood Pressure Measurement", CHARACTERISTIC_MAPPING_128.get(BLOOD_PRESSURE_MEASUREMENT_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(INTERMEDIATE_CUFF_PRESSURE_CHARACTERISTIC));
		assertEquals("Intermediate Cuff Pressure", CHARACTERISTIC_MAPPING_128.get(INTERMEDIATE_CUFF_PRESSURE_CHARACTERISTIC));
		...
		assertEquals("Heart Rate Control Point", CHARACTERISTIC_MAPPING_128.get(HEART_RATE_CONTROL_POINT_CHARACTERISTIC));
		...
		assertEquals("Alert Category ID Bit Mask", CHARACTERISTIC_MAPPING_128.get(ALERT_CATEGORY_ID_BIT_MASK_CHARACTERISTIC));
		...
		assertEquals("Alert Notification Control Point", CHARACTERISTIC_MAPPING_128.get(ALERT_NOTIFICATION_CONTROL_POINT_CHARACTERISTIC));
		...
		assertEquals("Supported New Alert Category", CHARACTERISTIC_MAPPING_128.get(SUPPORTED_NEW_ALERT_CATEGORY_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(SUPPORTED_UNREAD_ALERT_CATEGORY_CHARACTERISTIC));
		assertEquals("Supported Unread Alert Category", CHARACTERISTIC_MAPPING_128.get(SUPPORTED_UNREAD_ALERT_CATEGORY_CHARACTERISTIC));
		...
		assertEquals("Record Access Control Point", CHARACTERISTIC_MAPPING_128.get(RECORD_ACCESS_CONTROL_POINT_CHARACTERISTIC));
		...
		assertEquals("PLX Spot-Check Measurement", CHARACTERISTIC_MAPPING_128.get(PLX_SPOT_CHECK_MEASUREMENT_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(PLX_CONTINUOUS_MEASUREMENT_CHARACTERISTIC));
		assertEquals("PLX Continuous Measurement", CHARACTERISTIC_MAPPING_128.get(PLX_CONTINUOUS_MEASUREMENT_CHARACTERISTIC));
		...
		assertEquals("Cycling Power Measurement", CHARACTERISTIC_MAPPING_128.get(CYCLING_POWER_MEASUREMENT_CHARACTERISTIC));
		...
		assertEquals("Cycling Power Control Point", CHARACTERISTIC_MAPPING_128.get(CYCLING_POWER_CONTROL_POINT_CHARACTERISTIC));
		...
		assertEquals("Descriptor Value Changed", CHARACTERISTIC_MAPPING_128.get(DESCRIPTOR_VALUE_CHANGED_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(AEROBIC_HEART_RATE_LOWER_LIMIT_CHARACTERISTIC));
		assertEquals("Aerobic Heart Rate Lower Limit", CHARACTERISTIC_MAPPING_128.get(AEROBIC_HEART_RATE_LOWER_LIMIT_CHARACTERISTIC));
		...
		assertEquals("Anaerobic Heart Rate Lower Limit", CHARACTERISTIC_MAPPING_128.get(ANAEROBIC_HEART_RATE_LOWER_LIMIT_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(ANAEROBIC_HEART_RATE_UPPER_LIMIT_CHARACTERISTIC));
		assertEquals("Anaerobic Heart Rate Upper Limit", CHARACTERISTIC_MAPPING_128.get(ANAEROBIC_HEART_RATE_UPPER_LIMIT_CHARACTERISTIC));
		...
		assertEquals("Aerobic Heart Rate Upper Limit", CHARACTERISTIC_MAPPING_128.get(AEROBIC_HEART_RATE_UPPER_LIMIT_CHARACTERISTIC));
		...
		assertEquals("Date of Threshold Assessment", CHARACTERISTIC_MAPPING_128.get(DATE_OF_THRESHOLD_ASSESSMENT_CHARACTERISTIC));
		...
		assertEquals("Fat Burn Heart Rate Lower Limit", CHARACTERISTIC_MAPPING_128.get(FAT_BURN_HEART_RATE_LOWER_LIMIT_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(FAT_BURN_HEART_RATE_UPPER_LIMIT_CHARACTERISTIC));
		assertEquals("Fat Burn Heart Rate Upper Limit", CHARACTERISTIC_MAPPING_128.get(FAT_BURN_HEART_RATE_UPPER_LIMIT_CHARACTERISTIC));
		...
		assertEquals("Five Zone Heart Rate Limits", CHARACTERISTIC_MAPPING_128.get(FIVE_ZONE_HEART_RATE_LIMITS_CHARACTERISTIC));
		...
		assertEquals("Maximum Recommended Heart Rate", CHARACTERISTIC_MAPPING_128.get(MAXIMUM_RECOMMENDED_HEART_RATE_CHARACTERISTIC));
		...
		assertEquals("Sport Type for Aerobic and Anaerobic Thresholds", CHARACTERISTIC_MAPPING_128.get(SPORT_TYPE_FOR_AEROBIC_AND_ANAEROBIC_THRESHOLDS_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(THREE_ZONE_HEART_RATE_LIMITS_CHARACTERISTIC));
		assertEquals("Three Zone Heart Rate Limits", CHARACTERISTIC_MAPPING_128.get(THREE_ZONE_HEART_RATE_LIMITS_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(TWO_ZONE_HEART_RATE_LIMITS_CHARACTERISTIC));
		assertEquals("Two Zone Heart Rate Limits", CHARACTERISTIC_MAPPING_128.get(TWO_ZONE_HEART_RATE_LIMITS_CHARACTERISTIC));
		...
		assertEquals("Database Change Increment", CHARACTERISTIC_MAPPING_128.get(DATABASE_CHANGE_INCREMENT_CHARACTERISTIC));
		...
		assertEquals("Body Composition Feature", CHARACTERISTIC_MAPPING_128.get(BODY_COMPOSITION_FEATURE_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(BODY_COMPOSITION_MEASUREMENT_CHARACTERISTIC));
		assertEquals("Body Composition Measurement", CHARACTERISTIC_MAPPING_128.get(BODY_COMPOSITION_MEASUREMENT_CHARACTERISTIC));
		...
		assertEquals("Magnetic Flux Density - 2D", CHARACTERISTIC_MAPPING_128.get(MAGNETIC_FLUX_DENSITY_2D_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(MAGNETIC_FLUX_DENSITY_3D_CHARACTERISTIC));
		assertEquals("Magnetic Flux Density - 3D", CHARACTERISTIC_MAPPING_128.get(MAGNETIC_FLUX_DENSITY_3D_CHARACTERISTIC));
		...
		assertEquals("Barometric Pressure Trend", CHARACTERISTIC_MAPPING_128.get(BAROMETRIC_PRESSURE_TREND_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(BOND_MANAGEMENT_CONTROL_POINT_CHARACTERISTIC));
		assertEquals("Bond Management Control Point", CHARACTERISTIC_MAPPING_128.get(BOND_MANAGEMENT_CONTROL_POINT_CHARACTERISTIC));
		...
		assertEquals("Central Address Resolution", CHARACTERISTIC_MAPPING_128.get(CENTRAL_ADDRESS_RESOLUTION_CHARACTERISTIC));
		...
		assertEquals("CGM Specific Ops Control Point", CHARACTERISTIC_MAPPING_128.get(CGM_SPECIFIC_OPS_CONTROL_POINT_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(INDOOR_POSITIONING_CONFIGURATION_CHARACTERISTIC));
		assertEquals("Indoor Positioning Configuration", CHARACTERISTIC_MAPPING_128.get(INDOOR_POSITIONING_CONFIGURATION_CHARACTERISTIC));
		...
		assertEquals("Object Action Control Point", CHARACTERISTIC_MAPPING_128.get(OBJECT_ACTION_CONTROL_POINT_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(OBJECT_LIST_CONTROL_POINT_CHARACTERISTIC));
		assertEquals("Object List Control Point", CHARACTERISTIC_MAPPING_128.get(OBJECT_LIST_CONTROL_POINT_CHARACTERISTIC));
		...
		assertEquals("Resolvable Private Address Only", CHARACTERISTIC_MAPPING_128.get(RESOLVABLE_PRIVATE_ADDRESS_ONLY_CHARACTERISTIC));
		...
		assertEquals("Supported Inclination Range", CHARACTERISTIC_MAPPING_128.get(SUPPORTED_INCLINATION_RANGE_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(SUPPORTED_RESISTANCE_LEVEL_RANGE_CHARACTERISTIC));
		assertEquals("Supported Resistance Level Range", CHARACTERISTIC_MAPPING_128.get(SUPPORTED_RESISTANCE_LEVEL_RANGE_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(SUPPORTED_HEART_RATE_RANGE_CHARACTERISTIC));
		assertEquals("Supported Heart Rate Range", CHARACTERISTIC_MAPPING_128.get(SUPPORTED_HEART_RATE_RANGE_CHARACTERISTIC));
		...
		assertEquals("Fitness Machine Control Point", CHARACTERISTIC_MAPPING_128.get(FITNESS_MACHINE_CONTROL_POINT_CHARACTERISTIC));
		...
		assertEquals("Mesh Provisioning Data In", CHARACTERISTIC_MAPPING_128.get(MESH_PROVISIONING_DATA_IN_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(MESH_PROVISIONING_DATA_OUT_CHARACTERISTIC));
		assertEquals("Mesh Provisioning Data Out", CHARACTERISTIC_MAPPING_128.get(MESH_PROVISIONING_DATA_OUT_CHARACTERISTIC));
		...
		assertEquals("Chromatic Distance from Planckian", CHARACTERISTIC_MAPPING_128.get(CHROMATIC_DISTANCE_FROM_PLANCKIAN_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(CHROMATICITY_COORDINATES_CHARACTERISTIC));
		assertEquals("Chromaticity Coordinates", CHARACTERISTIC_MAPPING_128.get(CHROMATICITY_COORDINATES_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(CHROMATICITY_IN_CCT_AND_DUV_VALUES_CHARACTERISTIC));
		assertEquals("Chromaticity in CCT and Duv Values", CHARACTERISTIC_MAPPING_128.get(CHROMATICITY_IN_CCT_AND_DUV_VALUES_CHARACTERISTIC));
		...
		assertEquals("CIE 13.3-1995 Color Rendering Index", CHARACTERISTIC_MAPPING_128.get(CIE_13_3_1995_COLOR_RENDERING_INDEX_CHARACTERISTIC));
		...
		assertEquals("Correlated Color Temperature", CHARACTERISTIC_MAPPING_128.get(CORRELATED_COLOR_TEMPERATURE_CHARACTERISTIC));
		...
		assertEquals("Electric Current Specification", CHARACTERISTIC_MAPPING_128.get(ELECTRIC_CURRENT_SPECIFICATION_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(ELECTRIC_CURRENT_STATISTICS_CHARACTERISTIC));
		assertEquals("Electric Current Statistics", CHARACTERISTIC_MAPPING_128.get(ELECTRIC_CURRENT_STATISTICS_CHARACTERISTIC));
		...
		assertEquals("Energy in a Period of Day", CHARACTERISTIC_MAPPING_128.get(ENERGY_IN_A_PERIOD_OF_DAY_CHARACTERISTIC));
		...
		assertEquals("Global Trade Item Number", CHARACTERISTIC_MAPPING_128.get(GLOBAL_TRADE_ITEM_NUMBER_CHARACTERISTIC));
		...
		assertEquals("Relative Runtime in a Current Range", CHARACTERISTIC_MAPPING_128.get(RELATIVE_RUNTIME_IN_A_CURRENT_RANGE_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(RELATIVE_RUNTIME_IN_A_GENERIC_LEVEL_RANGE_CHARACTERISTIC));
		assertEquals("Relative Runtime in a Generic Level Range", CHARACTERISTIC_MAPPING_128.get(RELATIVE_RUNTIME_IN_A_GENERIC_LEVEL_RANGE_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(RELATIVE_VALUE_IN_A_VOLTAGE_RANGE_CHARACTERISTIC));
		assertEquals("Relative Value in a Voltage Range", CHARACTERISTIC_MAPPING_128.get(RELATIVE_VALUE_IN_A_VOLTAGE_RANGE_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(RELATIVE_VALUE_IN_AN_ILLUMINANCE_RANGE_CHARACTERISTIC));
		assertEquals("Relative Value in an Illuminance Range", CHARACTERISTIC_MAPPING_128.get(RELATIVE_VALUE_IN_AN_ILLUMINANCE_RANGE_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(RELATIVE_VALUE_IN_A_PERIOD_OF_DAY_CHARACTERISTIC));
		assertEquals("Relative Value in a Period of Day", CHARACTERISTIC_MAPPING_128.get(RELATIVE_VALUE_IN_A_PERIOD_OF_DAY_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(RELATIVE_VALUE_IN_A_TEMPERATURE_RANGE_CHARACTERISTIC));
		assertEquals("Relative Value in a Temperature Range", CHARACTERISTIC_MAPPING_128.get(RELATIVE_VALUE_IN_A_TEMPERATURE_RANGE_CHARACTERISTIC));
		...
		assertEquals("Temperature 8 in a Period of Day", CHARACTERISTIC_MAPPING_128.get(TEMPERATURE_8_IN_A_PERIOD_OF_DAY_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(TEMPERATURE_8_STATISTICS_CHARACTERISTIC));
		assertEquals("Temperature 8 Statistics", CHARACTERISTIC_MAPPING_128.get(TEMPERATURE_8_STATISTICS_CHARACTERISTIC));
		...
		assertEquals("Reconnection Configuration Control Point", CHARACTERISTIC_MAPPING_128.get(RECONNECTION_CONFIGURATION_CONTROL_POINT_CHARACTERISTIC));
		...
		assertEquals("IDD Status Reader Control Point", CHARACTERISTIC_MAPPING_128.get(IDD_STATUS_READER_CONTROL_POINT_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(IDD_COMMAND_CONTROL_POINT_CHARACTERISTIC));
		assertEquals("IDD Command Control Point", CHARACTERISTIC_MAPPING_128.get(IDD_COMMAND_CONTROL_POINT_CHARACTERISTIC));
		...
		assertEquals("IDD Record Access Control Point", CHARACTERISTIC_MAPPING_128.get(IDD_RECORD_ACCESS_CONTROL_POINT_CHARACTERISTIC));
		...
		assertEquals("Client Supported Features", CHARACTERISTIC_MAPPING_128.get(CLIENT_SUPPORTED_FEATURES_CHARACTERISTIC));
		...
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(ACS_DATA_OUT_NOTIFY_CHARACTERISTIC));
		assertEquals("ACS Data Out Notify", CHARACTERISTIC_MAPPING_128.get(ACS_DATA_OUT_NOTIFY_CHARACTERISTIC));
		...
		assertEquals("Enhanced Blood Pressure Measurement", CHARACTERISTIC_MAPPING_128.get(ENHANCED_BLOOD_PRESSURE_MEASUREMENT_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(ENHANCED_INTERMEDIATE_CUFF_PRESSURE_CHARACTERISTIC));
		assertEquals("Enhanced Intermediate Cuff Pressure", CHARACTERISTIC_MAPPING_128.get(ENHANCED_INTERMEDIATE_CUFF_PRESSURE_CHARACTERISTIC));
		...
		assertEquals("Server Supported Features", CHARACTERISTIC_MAPPING_128.get(SERVER_SUPPORTED_FEATURES_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(PHYSICAL_ACTIVITY_MONITOR_FEATURES_CHARACTERISTIC));
		assertEquals("Physical Activity Monitor Features", CHARACTERISTIC_MAPPING_128.get(PHYSICAL_ACTIVITY_MONITOR_FEATURES_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(GENERAL_ACTIVITY_INSTANTANEOUS_DATA_CHARACTERISTIC));
		assertEquals("General Activity Instantaneous Data", CHARACTERISTIC_MAPPING_128.get(GENERAL_ACTIVITY_INSTANTANEOUS_DATA_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(GENERAL_ACTIVITY_SUMMARY_DATA_CHARACTERISTIC));
		assertEquals("General Activity Summary Data", CHARACTERISTIC_MAPPING_128.get(GENERAL_ACTIVITY_SUMMARY_DATA_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(CARDIO_RESPIRATORY_ACTIVITY_INSTANTANEOUS_DATA_CHARACTERISTIC));
		assertEquals("CardioRespiratory Activity Instantaneous Data", CHARACTERISTIC_MAPPING_128.get(CARDIO_RESPIRATORY_ACTIVITY_INSTANTANEOUS_DATA_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(CARDIO_RESPIRATORY_ACTIVITY_SUMMARY_DATA_CHARACTERISTIC));
		assertEquals("CardioRespiratory Activity Summary Data", CHARACTERISTIC_MAPPING_128.get(CARDIO_RESPIRATORY_ACTIVITY_SUMMARY_DATA_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(STEP_COUNTER_ACTIVITY_SUMMARY_DATA_CHARACTERISTIC));
		assertEquals("Step Counter Activity Summary Data", CHARACTERISTIC_MAPPING_128.get(STEP_COUNTER_ACTIVITY_SUMMARY_DATA_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(SLEEP_ACTIVITY_INSTANTANEOUS_DATA_CHARACTERISTIC));
		assertEquals("Sleep Activity Instantaneous Data", CHARACTERISTIC_MAPPING_128.get(SLEEP_ACTIVITY_INSTANTANEOUS_DATA_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(SLEEP_ACTIVITY_SUMMARY_DATA_CHARACTERISTIC));
		assertEquals("Sleep Activity Summary Data", CHARACTERISTIC_MAPPING_128.get(SLEEP_ACTIVITY_SUMMARY_DATA_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(PHYSICAL_ACTIVITY_MONITOR_CONTROL_POINT_CHARACTERISTIC));
		assertEquals("Physical Activity Monitor Control Point", CHARACTERISTIC_MAPPING_128.get(PHYSICAL_ACTIVITY_MONITOR_CONTROL_POINT_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(ACTIVITY_CURRENT_SESSION_CHARACTERISTIC));
		assertEquals("Activity Current Session", CHARACTERISTIC_MAPPING_128.get(ACTIVITY_CURRENT_SESSION_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(PHYSICAL_ACTIVITY_SESSION_DESCRIPTOR_CHARACTERISTIC));
		assertEquals("Physical Activity Session Descriptor", CHARACTERISTIC_MAPPING_128.get(PHYSICAL_ACTIVITY_SESSION_DESCRIPTOR_CHARACTERISTIC));
		...
		assertEquals("Four Zone Heart Rate Limits", CHARACTERISTIC_MAPPING_128.get(FOUR_ZONE_HEART_RATE_LIMITS_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(HIGH_INTENSITY_EXERCISE_THRESHOLD_CHARACTERISTIC));
		assertEquals("High Intensity Exercise Threshold", CHARACTERISTIC_MAPPING_128.get(HIGH_INTENSITY_EXERCISE_THRESHOLD_CHARACTERISTIC));
		...
		assertEquals("Sedentary Interval Notification", CHARACTERISTIC_MAPPING_128.get(SEDENTARY_INTERVAL_NOTIFICATION_CHARACTERISTIC));
		...
		assertEquals("Audio Input Control Point", CHARACTERISTIC_MAPPING_128.get(AUDIO_INPUT_CONTROL_POINT_CHARACTERISTIC));
		...
		assertEquals("Volume Offset Control Point", CHARACTERISTIC_MAPPING_128.get(VOLUME_OFFSET_CONTROL_POINT_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(AUDIO_OUTPUT_DESCRIPTION_CHARACTERISTIC));
		assertEquals("Audio Output Description", CHARACTERISTIC_MAPPING_128.get(AUDIO_OUTPUT_DESCRIPTION_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(SET_IDENTITY_RESOLVING_KEY_CHARACTERISTIC));
		assertEquals("Set Identity Resolving Key", CHARACTERISTIC_MAPPING_128.get(SET_IDENTITY_RESOLVING_KEY_CHARACTERISTIC));
		...
		assertEquals("Encrypted Data Key Material", CHARACTERISTIC_MAPPING_128.get(ENCRYPTED_DATA_KEY_MATERIAL_CHARACTERISTIC));
		...
		assertEquals("Device Time Control Point", CHARACTERISTIC_MAPPING_128.get(DEVICE_TIME_CONTROL_POINT_CHARACTERISTIC));
		...
		assertEquals("Media Player Icon Object ID", CHARACTERISTIC_MAPPING_128.get(MEDIA_PLAYER_ICON_OBJECT_ID_CHARACTERISTIC));
		...
		assertEquals("Current Track Segments Object ID", CHARACTERISTIC_MAPPING_128.get(CURRENT_TRACK_SEGMENTS_OBJECT_ID_CHARACTERISTIC));
		...
		assertEquals("Playing Orders Supported", CHARACTERISTIC_MAPPING_128.get(PLAYING_ORDERS_SUPPORTED_CHARACTERISTIC));
		...
		assertEquals("Media Control Point Opcodes Supported", CHARACTERISTIC_MAPPING_128.get(MEDIA_CONTROL_POINT_OPCODES_SUPPORTED_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(SEARCH_RESULTS_OBJECT_ID_CHARACTERISTIC));
		assertEquals("Search Results Object ID", CHARACTERISTIC_MAPPING_128.get(SEARCH_RESULTS_OBJECT_ID_CHARACTERISTIC));
		...
		assertEquals("Media Player Icon Object Type", CHARACTERISTIC_MAPPING_128.get(MEDIA_PLAYER_ICON_OBJECT_TYPE_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(TRACK_SEGMENTS_OBJECT_TYPE_CHARACTERISTIC));
		assertEquals("Track Segments Object Type", CHARACTERISTIC_MAPPING_128.get(TRACK_SEGMENTS_OBJECT_TYPE_CHARACTERISTIC));
		...
		assertEquals("Constant Tone Extension Enable", CHARACTERISTIC_MAPPING_128.get(CONSTANT_TONE_EXTENSION_ENABLE_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(ADVERTISING_CONSTANT_TONE_EXTENSION_MINIMUM_LENGTH_CHARACTERISTIC));
		assertEquals("Advertising Constant Tone Extension Minimum Length", CHARACTERISTIC_MAPPING_128.get(ADVERTISING_CONSTANT_TONE_EXTENSION_MINIMUM_LENGTH_CHARACTERISTIC));
		...
		assertEquals("Advertising Constant Tone Extension Minimum Transmit Count", CHARACTERISTIC_MAPPING_128.get(ADVERTISING_CONSTANT_TONE_EXTENSION_MINIMUM_TRANSMIT_COUNT_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(ADVERTISING_CONSTANT_TONE_EXTENSION_TRANSMIT_DURATION_CHARACTERISTIC));
		assertEquals("Advertising Constant Tone Extension Transmit Duration", CHARACTERISTIC_MAPPING_128.get(ADVERTISING_CONSTANT_TONE_EXTENSION_TRANSMIT_DURATION_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(ADVERTISING_CONSTANT_TONE_EXTENSION_INTERVAL_CHARACTERISTIC));
		assertEquals("Advertising Constant Tone Extension Interval", CHARACTERISTIC_MAPPING_128.get(ADVERTISING_CONSTANT_TONE_EXTENSION_INTERVAL_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(ADVERTISING_CONSTANT_TONE_EXTENSION_PHY_CHARACTERISTIC));
		assertEquals("Advertising Constant Tone Extension PHY", CHARACTERISTIC_MAPPING_128.get(ADVERTISING_CONSTANT_TONE_EXTENSION_PHY_CHARACTERISTIC));
		...
		assertEquals("Bearer URI Schemes Supported List", CHARACTERISTIC_MAPPING_128.get(BEARER_URI_SCHEMES_SUPPORTED_LIST_CHARACTERISTIC));
		...
		assertEquals("Bearer Signal Strength Reporting Interval", CHARACTERISTIC_MAPPING_128.get(BEARER_SIGNAL_STRENGTH_REPORTING_INTERVAL_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(BEARER_LIST_CURRENT_CALLS_CHARACTERISTIC));
		assertEquals("Bearer List Current Calls", CHARACTERISTIC_MAPPING_128.get(BEARER_LIST_CURRENT_CALLS_CHARACTERISTIC));
		...
		assertEquals("Incoming Call Target Bearer URI", CHARACTERISTIC_MAPPING_128.get(INCOMING_CALL_TARGET_BEARER_URI_CHARACTERISTIC));
		...
		assertEquals("Call Control Point Optional Opcodes", CHARACTERISTIC_MAPPING_128.get(CALL_CONTROL_POINT_OPTIONAL_OPCODES_CHARACTERISTIC));
		...
		assertEquals("Broadcast Audio Scan Control Point", CHARACTERISTIC_MAPPING_128.get(BROADCAST_AUDIO_SCAN_CONTROL_POINT_CHARACTERISTIC));
		...
		assertEquals("Available Audio Contexts", CHARACTERISTIC_MAPPING_128.get(AVAILABLE_AUDIO_CONTEXTS_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(SUPPORTED_AUDIO_CONTEXTS_CHARACTERISTIC));
		assertEquals("Supported Audio Contexts", CHARACTERISTIC_MAPPING_128.get(SUPPORTED_AUDIO_CONTEXTS_CHARACTERISTIC));
		...
		assertEquals("Carbon Monoxide Concentration", CHARACTERISTIC_MAPPING_128.get(CARBON_MONOXIDE_CONCENTRATION_CHARACTERISTIC));
		...
		assertEquals("Nitrogen Dioxide Concentration", CHARACTERISTIC_MAPPING_128.get(NITROGEN_DIOXIDE_CONCENTRATION_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(NON_METHANE_VOLATILE_ORGANIC_COMPOUNDS_CONCENTRATION_CHARACTERISTIC));
		assertEquals("Non-Methane Volatile Organic Compounds Concentration", CHARACTERISTIC_MAPPING_128.get(NON_METHANE_VOLATILE_ORGANIC_COMPOUNDS_CONCENTRATION_CHARACTERISTIC));
		...
		assertEquals("Particulate Matter - PM1 Concentration", CHARACTERISTIC_MAPPING_128.get(PARTICULATE_MATTER_PM1_CONCENTRATION_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(PARTICULATE_MATTER_PM2_5_CONCENTRATION_CHARACTERISTIC));
		assertEquals("Particulate Matter - PM2.5 Concentration", CHARACTERISTIC_MAPPING_128.get(PARTICULATE_MATTER_PM2_5_CONCENTRATION_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(PARTICULATE_MATTER_PM10_CONCENTRATION_CHARACTERISTIC));
		assertEquals("Particulate Matter - PM10 Concentration", CHARACTERISTIC_MAPPING_128.get(PARTICULATE_MATTER_PM10_CONCENTRATION_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(SULFUR_DIOXIDE_CONCENTRATION_CHARACTERISTIC));
		assertEquals("Sulfur Dioxide Concentration", CHARACTERISTIC_MAPPING_128.get(SULFUR_DIOXIDE_CONCENTRATION_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(SULFUR_HEXAFLUORIDE_CONCENTRATION_CHARACTERISTIC));
		assertEquals("Sulfur Hexafluoride Concentration", CHARACTERISTIC_MAPPING_128.get(SULFUR_HEXAFLUORIDE_CONCENTRATION_CHARACTERISTIC));
		...
		assertEquals("Hearing Aid Preset Control Point", CHARACTERISTIC_MAPPING_128.get(HEARING_AID_PRESET_CONTROL_POINT_CHARACTERISTIC));
		...
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(RELATIVE_RUNTIME_IN_A_CORRELATED_COLOR_TEMPERATURE_RANGE_CHARACTERISTIC));
		assertEquals("Relative Runtime in a Correlated Color Temperature Range", CHARACTERISTIC_MAPPING_128.get(RELATIVE_RUNTIME_IN_A_CORRELATED_COLOR_TEMPERATURE_RANGE_CHARACTERISTIC));
		...
		assertEquals("Battery Health Information", CHARACTERISTIC_MAPPING_128.get(BATTERY_HEALTH_INFORMATION_CHARACTERISTIC));
		...
		assertEquals("ESL Response Key Material", CHARACTERISTIC_MAPPING_128.get(ESL_RESPONSE_KEY_MATERIAL_CHARACTERISTIC));
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(ESL_CURRENT_ABSOLUTE_TIME_CHARACTERISTIC));
		assertEquals("ESL Current Absolute Time", CHARACTERISTIC_MAPPING_128.get(ESL_CURRENT_ABSOLUTE_TIME_CHARACTERISTIC));
