...
public class CharacteristicUUIDTest {
	...
	public void test_map_00001() {
		...
		assertTrue(CHARACTERISTIC_MAPPING_128.containsKey(E_S_L_CURRENT_ABSOLUTE_TIME_CHARACTERISTIC));
		assertEquals("ESL Current Absolute Time",
				CHARACTERISTIC_MAPPING_128.get(E_S_L_CURRENT_ABSOLUTE_TIME_CHARACTERISTIC));
