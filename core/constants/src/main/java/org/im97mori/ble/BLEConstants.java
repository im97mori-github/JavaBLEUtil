...
public class BLEConstants {
    ...
    /**
     * use {@link org.im97mori.ble.constants.AppearanceUUID#APPEARANCE_SUB_CATEGORY_MAPPING_128}
     */
    @Deprecated
    ...
    static {
        ...
        for (Map.Entry<UUID, String> entry : org.im97mori.ble.constants.AppearanceUUID.APPEARANCE_SUB_CATEGORY_MAPPING_128.entrySet()) {
    ...
    /**
     * use {@link org.im97mori.ble.constants.SchemeUUID#SCHEME_MAPPING_128}
     */
    @Deprecated
    ...
    static {
        Map<Integer, String> map = new HashMap<>();
        for (Map.Entry<UUID, String> entry : org.im97mori.ble.constants.SchemeUUID.SCHEME_MAPPING_128.entrySet()) {
            long msb = entry.getKey().getMostSignificantBits();
            map.put((int) ((msb >> 32) & 0xffff), entry.getValue());
        }
